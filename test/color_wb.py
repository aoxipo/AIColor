...
if __name__ == '__main__':
    ...
    parser.add_argument("--balance_method", type=int, default=2, help="balance index")
    method_index = {
        
        0: white_balance_1,  #均值白平衡法
        1:white_balance_1,   #均值白平衡法
        2:white_balance_2,   #完美反射
        3:white_balance_3,   #灰度世界假设
        4:white_balance_4,   #基于图像分析的偏色检测及颜色校正方法
        5:white_balance_5,   #动态阈值算法
    }
    ...
    for (root, dirs, files) in os.walk(image_path):
        ...
        for index_file in files:
            ...
            image_new = method_index[method](img)
            ...
            cv2.imwrite(image_path_saved, image_new)
